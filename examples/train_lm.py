...
print(sum(tensor_mask))
config = PerceiverConfig(
  input_len = 1024, latent_len = 64, output_len = 1024,
  input_dim = 8, latent_dim = 128, output_dim = 128,
  num_layers = 6, ffw_latent = 128,
  n_classes = len(vocabulary), num_heads = 8,
