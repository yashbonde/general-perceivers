# this file has code for training pipeline distributed model from
        ...
        if batch % log_interval == 0 and batch > 0:
            ...
            print(
                ...
                "loss {:5.2f} | ppl {:8.2f}".format(
                    epoch, batch, nbatches // bptt, scheduler.get_lr()[0], elapsed * 1000 / log_interval, cur_loss, math.exp(cur_loss)
                )
            )
            total_loss = 0
            start_time = time.time()
